...
from src.utils.const import G_HINT_THRESHOLD, GENERATOR, REVISER
from src.utils.template import generator_template_p1, generator_hint_template, generator_template_p2
from src.utils.utils import parse_list, parse_sql, user_message, get_response_content, timeout
...
class Generator(Agent_Base):
    ...
    def get_rela_tips(
        ...
        tips = vectordb.get_related_tip(query_texts=question, extracts=['distances', 'documents'])
